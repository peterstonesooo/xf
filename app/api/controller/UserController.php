...
class UserController extends AuthController
{
    public function userInfo()
    {
        ...
        $user = User::where('id', $user['id'])
                    ->field('id,phone,realname,pay_password,up_user_id,is_active,invite_code,ic_number,level,balance,topup_balance,team_bonus_balance,appreciating_wallet,butie_lock,created_at,qq,avatar,digit_balance,butie,integral,tiyan_wallet,tiyan_wallet_lock,xingfu_tickets,puhui,zhenxing_wallet,vote_tickets')
                    ->find()
                    ->toArray();
