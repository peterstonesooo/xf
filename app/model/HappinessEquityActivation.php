...
class HappinessEquityActivation extends Model
{
    ...
    public static function createActivation($userId, $equityRate, $walletBalances, $totalBalance, $paymentAmount, $beforeTopupBalance, $afterTopupBalance)
    {
        ...
        return self::create([
            ...
            'topup_balance' => $walletBalances['topup_balance'] ?? 0,
            'team_bonus_balance' => $walletBalances['team_bonus_balance'] ?? 0,
            'butie_balance' => $walletBalances['butie'] ?? 0,
            'balance' => $walletBalances['balance'] ?? 0,
            'digit_balance' => $walletBalances['digit_balance'] ?? 0,
