<?php /*a:4:{s:85:"/Applications/XAMPP/xamppfiles/htdocs/xf/app/admin/view/user/show_change_balance.html";i:1754294219;s:67:"/Applications/XAMPP/xamppfiles/htdocs/xf/app/admin/view/layout.html";i:1754294218;s:65:"/Applications/XAMPP/xamppfiles/htdocs/xf/app/admin/view/head.html";i:1754294218;s:65:"/Applications/XAMPP/xamppfiles/htdocs/xf/app/admin/view/left.html";i:1754294218;}*/ ?>
<!DOCTYPE html>
<html>
            ...
            <div class="box box-body">
                <div class="row dd_input_group">
                    <div class="form-group">
                        <input name="user_id" type="hidden" value="<?php echo htmlentities($req['user_id']); ?>">
                ...
                <div class="row dd_input_group">
                    <div class="form-group">
                        <label class="col-xs-4 col-sm-2 col-md-2 col-lg-1 control-label dd_input_l">充值类型</label>
                        <div class="col-xs-7 col-sm-6 col-md-4 col-lg-4">
                            <select name="type">
                                <option value="12">专属充值</option>
                                <option value="1">余额</option>
                                <option value="2">民生钱包</option>
                                <option value="3">荣誉钱包</option>
                                <option value="4">收益钱包</option>
                                <option value="5">稳盈钱包</option>
...
<script>
    $(function () {
        ...
        var typeText = "<?php echo config('map.user_balance_log.type_map')[$req['type']]; ?>";
